...
import MoneyPicture from '../../assets/MoneyPicture.jpg'

const AddPaymentModel = ({ idSelectedUser }) => {
  ...
  <img
    src={MoneyPicture}
    alt="logo"
    className="w-40 h-40 rounded-full cursor-pointer border-4 border-black"
  />
</div>
